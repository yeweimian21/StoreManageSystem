...
<html>
		...
		<head>
			...
			<title>My JSP 'DeleteRole.jsp' starting page</title>
	...
	-->
		...
		<body>
			<div class="container">
				...
				<form class="form-horizontal" role="form" action="deleteRole"
					method="get">
			...
			<script src="bootstrap-3.3.0/dist/js/bootstrap.min.js"
				type="text/javascript"></script>
			<script src="JS/MyJS/ManageUserJS/DeleteRoleCopy.js" type="text/javascript"></script>
		</body>
	</html>