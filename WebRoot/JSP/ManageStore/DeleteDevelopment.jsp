...
<html>
	...
	<head>
		...
		<title>My JSP 'DeleteDevelopment.jsp' starting page</title>
	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" role="form" action="deleteDevelopment"
				method="get" id="form1">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<input type="hidden" id="getdevelopmentid" name="developmentId"
									value="">
							</div>
						</div>
					</div>
		...
		<script src="bootstrap-3.3.0/dist/js/bootstrap.min.js"
			type="text/javascript"></script>
		<script src="JS/MyJS/ManageStoreJS/DeleteDevelopmentCopy.js" type="text/javascript"></script>
	</body>
</html>
